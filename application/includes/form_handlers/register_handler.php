<?php
    ...
    if(isset($_POST['register_button'])) {
        ...
        if(count($reg_error_array) == 0) {
            ...
            $profile_pic = $rand == 1 ? "application/assets/images/profile_pics/defaults/head_deep_blue.png" : "application/assets/images/profile_pics/defaults/head_emerald.png";
